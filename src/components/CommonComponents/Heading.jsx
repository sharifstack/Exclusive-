  ...
  return (
    <div className="flex justify-between sm:justify-normal sm:flex-col gap-6">
      <div className="flex items-center gap-1 sm:gap-4">
        ...
        <h3 className="text-Secondary2_DB4444 font-poppins font-semibold text-[16px]  sm:text-base">
          {title ? title : "Today's"}
        </h3>
      </div>

      {desc && (
        <h1 className="font-inter text-[16px] sm:text-4xl font-semibold text-Text2_000000">
