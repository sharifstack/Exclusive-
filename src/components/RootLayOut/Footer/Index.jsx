  ...
  return (
    <div className=" bg-button_000000">
      <div className="container">
        <div className="flex">
          <div className="one w-1/5 pt-[80px]">
            <div className="">
              <div className="logo">
          ...
          <div className="two w-1/5 pt-[80px]">
            <div>
          ...
          <div className="three w-1/5 pt-[80px] pb-10 ">
            <div>
              <h3 className="font-poppins font-medium text-xl text-text_FAFAFA mb-6">
                Account
              </h3>
          ...
          <div className="four-orange-300 w-1/5 pt-[80px]">
            <div>
              <h3 className="font-poppins font-medium text-xl text-text_FAFAFA mb-6">
                Quick Link
              </h3>
          ...
          <div className="five w-1/5 pt-[80px]">
            <div>
              <h3 className="font-poppins font-medium text-xl text-text_FAFAFA mb-6">
                Download App
              </h3>
