            ...
            <div className="flex items-end gap-2">
              <div className="ResponsiveSideDrawer flex sm:hidden">
                ...
                <div
                  ...
                  class="fixed top-0 left-0 z-50 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white w-64 dark:bg-Text1_7D8184 "
                  tabindex="-1"
                  ...
                  <div class="py-4 overflow-y-auto ">
                    <ul class="space-y-2 font-medium">
                      <li>
                        ...
                        >
                          <svg
                            class="w-5 h-5 text-white transition duration-75 group-hover:text-gray-900 dark:group-hover:text-white"
                            aria-hidden="true"
                            xmlns="http://www.w3.org/2000/svg"
                            fill="currentColor"
                            viewBox="0 0 22 21"
